...
class PasswordGenerator:
    ...
    def showpswd(self,data,pswd):
        ...
        root.iconbitmap(r"D:\\Abhijeet\\VIV\\PasswordGenerator.ico")
        style = ttk.Style()
...
class TextSpeech:
    ...
    def opentxt(self):
        ...
        try:
            file_path=filedialog.askopenfilename(initialdir =r"D:\\Abhijeet\\VIV\\Notes",title="Select file",filetypes=(('text file',"*.txt"),("All files", "*.*")))
    ...
    def __init__(self):
        ...
        self.root.iconbitmap(r"D:\\Abhijeet\\VIV\\text_to_speech.ico")
        #root widget
...
class SettingWindow:
    ...
    def settingWindow(self,root):
        ...
        self.setting.iconbitmap(r"D:\\Abhijeet\\VIV\\setting.ico")
        self.setting.geometry("285x180+500+200")
        self.setting.resizable(0,0)
        self.volume=ttk.Label(self.setting,text="VIV's Volume: ",borderwidth=0,font=('"Times New Roman"')).place(x=3,y=17)
...
class camera:
    def takePhoto(self):
        ...
        os.chdir(a)
        playsound.playsound("D:\\Abhijeet\\VIV\\camera-shutter-click.mp3")
...
class Weather:
    def show(self,scrollable_text):
        SR=SpeakRecog(scrollable_text)
        base_url = "http://api.openweathermap.org/data/2.5/weather?q=Mumbai,IN&units=metric&appid=ea45752424c9cad83b4f5c836ced6b1a"
